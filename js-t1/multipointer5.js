...
function findPair(array,differenceTarget)
{
  if(array.length ==0)
  {
    return false
  ...
  while(ptr1<ptr2)
  {
    let diff = array[ptr1]-array[ptr2];
  
    if(diff===differenceTarget)
    {
     
      return true;
    }
    else if(diff>differenceTarget)
    {
      ptr2++;
    }
    else
...
console.log(findPair([8,6,2,4,1,0,2,5,13],1)) // true-false
console.log(findPair([4,-2,3,10],-6)) // true
console.log(findPair([6,1,4,10,2,4], 22)) // false
console.log(findPair([], 0)) // false
console.log(findPair([5,5], 0)) // true
console.log(findPair([-4,4], -8)) // true
console.log(findPair([-4,4], 8)) // true-false
